...
terminal = "alacritty"
editor = os.getenv("zeditor") or "nvim"
...
globalkeys = gears.table.join(
    ...
    awful.util.spawn("dmenu_run") end,
              {description = "launch dmenu", group = "alaa"}),
    
        -- Browser
    awful.key({ modkey },            "b",     function ()
    awful.util.spawn("floorp") end,
              {description = "launch browser (floorp)", group = "alaa"}),
    -- Spotify
    awful.key({ modkey },            "v",     function ()
    awful.util.spawn("spotify") end,
              {description = "launch spotify", group = "alaa"}),
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey,	"Shift" }, "Left",
 		  ...
 		  {description = "Move window to previous Workspace", group = "tag"}),
        ...
        awful.key({ modkey,	"Shift" }, "Right",
		      ...
		      if client.focus then
                  ...
                  {description = "Move window to next Workspace", group = "tag"})
    )
end
