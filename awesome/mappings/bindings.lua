...
-- Volume control
awful.keyboard.append_global_keybindings({
    awful.key({}, "XF86AudioRaiseVolume", function () os.execute("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 1%+") end, 
              {description = "Volume +2", group = "hotkeys"}),

    awful.key({}, "XF86AudioLowerVolume", function () os.execute("wpctl set-volume @DEFAULT_AUDIO_SINK@ 1%-") end, 
              {description = "Volume +2", group = "hotkeys"}),
